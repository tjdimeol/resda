...
def load_model_ensemble_and_task(
    ...
    print("in checkpoint_utils.py just after def load_model_ensemble_and_task")
    #print(arg_overrides)
    #print(filenames)
    #time.sleep(3)
    ...
    ensemble = []
    cfg = None
    #print("ensemble, cfg, num_shards ", ensemble, cfg, num_shards)
    #time.sleep(3)
    for filename in filenames:
        ...
        for shard_idx in range(num_shards):
            ...
            if "fsdp_metadata" in state and num_shards > 1:
                ...
                print("in checkpoint_utils.py ")
                #time.sleep(5)
                model = task.build_model(cfg.model)
                #print("after task.build_model(cfg.model)")
                #time.sleep(5)
                model.load_state_dict(
                    state["model"], strict=strict, model_cfg=cfg.model
                )
                #print("after model.load_state_dict ")
                #time.sleep(5)
