...
class EpochBatchIterator(EpochBatchIterating):
    ...
    def frozen_batches(self):
        ...
        #print("_frozen_batches is ", self._frozen_batches, "dataset is ", self.dataset, "epoch is ", self.epoch)
    ...
    def first_batch(self):
        ...
        if getattr(self.dataset, "supports_fetch_outside_dataloader", True):
            #print("here")
            #print("self.frozen_batches[0] is ", self.frozen_batches[0])
            thing = self.collate_fn([self.dataset[i] for i in self.frozen_batches[0]])
            #print("i is ", i)
            #time.sleep(10)
